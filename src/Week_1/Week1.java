package Week_1;
import Week_1.SingelyLinkedList;
...
public class Week1 {
     ...
     SingelyLinkedList.Node first_itterator = a.head;
     SingelyLinkedList.Node second_itterator = b.head;
     ...
     SingelyLinkedList.Node current = list.head, index = null;
     int temp;
